            ...
            <div class="w-[40%]">
                ...
                <div class="w-full mt-10">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="relative w-[92%] flex border border-light rounded shadow-md">
                    ...
                    <div class="flex justify-between mt-5 items-center">
                        ...
                        <div class="relative w-[92%] flex border border-black rounded shadow-md">
                    ...
                    <div class="flex justify-between mt-5 items-center">
                        ...
                        <div class="relative w-[92%] flex border border-dark rounded shadow-md">
                    ...
                    <div class="flex justify-between mt-5 items-center">
                        ...
                        <div class="relative w-[92%] flex border border-mid rounded shadow-md">
